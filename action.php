...
if(isset($_POST["update_profile"])){
    ...
    if(empty($f_name) || empty($l_name) || empty($mobile) || empty($address1) || empty($address2)){
        echo "
			<div class='alert alert-warning'>
    ...
    if(isset($_POST["password"]) && !empty($_POST["password"])){
        ...
        // $password = md5($password); // Removed MD5 as system uses plain text for users
         $sql = "UPDATE user_info SET first_name='$f_name', last_name='$l_name', mobile='$mobile', address1='$address1', address2='$address2', password='$password' WHERE user_id='$user_id'";
    } else {
         $sql = "UPDATE user_info SET first_name='$f_name', last_name='$l_name', mobile='$mobile', address1='$address1', address2='$address2' WHERE user_id='$user_id'";
    }
